...
const LoginPage = () => {
  ...
  return (
    <Container component={Paper} maxWidth='sm' className="loginContainerStyle">
      ...
      <Box component="form" 
          ...
          noValidate className="loginFormStyle"
      >
        <TextField
          margin="normal"
          required
        ...
        <LoadingButton 
          ...
          type="submit" 
          fullWidth 
          variant="contained" className="loginLoadingButtonStyle"
        >
          Sign In
        </LoadingButton>
        <Grid container>
          <Grid item>
            <Link to='/register' style={{ textDecoration: 'none', color: "rgb(156, 39, 176)"}}>
